			...
			<div class="col-md-3 col-xs-12 col-sm-12"> <!--colในส่วนซ้าย ที่มี รายละเอียดของผู้ใช้งาน-->
				  <div class="col-md-12 col-xs-12 col-sm-12">
					...
					<div class="col-md-12 col-xs-12 col-sm-12">
						...
						<center>
							<br>
							<button type="button" class="btn btn-primary navbar-btn"><a href="../../album/show/<?$ID = $this->session->all_userdata(); echo "".$ID['ID'].?>"><div class="link">See More Album</div></a></button> <!-----see album----->
						</center>
						</ul>
					</div>
						<div class="box">							
