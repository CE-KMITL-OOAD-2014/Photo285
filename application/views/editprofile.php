...
<div class ="col-md-2"></div>
						...
						<div class="col-md-12">  <!--ส่วนกรอก username----A-->
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="ID" class="form-control " width = "50%" id="exampleInputUsername1" placeholder="### ตรงนี้ต้องเปลี่ยน เป็น USERNAME" readonly="readonly"required autofocus>
									</div>
								</div>
